...
async def open_new_chat_command(interaction: discord.Interaction, user: discord.Member):
    ...
    try:
        ...
        class TradeEndView(discord.ui.View):
            ...
            @discord.ui.button(label="거래 종료 요청", style=discord.ButtonStyle.danger)
            ...
            @discord.ui.button(label="상대 후기 남기기", style=discord.ButtonStyle.primary)
            async def leave_review(self, interaction_button: discord.Interaction, button: discord.ui.Button):
                ...
                class ReviewChoiceView(discord.ui.View):
                    ...
                    @discord.ui.button(label="좋았어요 👍", style=discord.ButtonStyle.success)
        ...
        class ConfirmView(discord.ui.View):
            ...
            @discord.ui.button(label="👍 종료 동의", style=discord.ButtonStyle.success, emoji="👍")
